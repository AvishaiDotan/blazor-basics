...
namespace VeggieFarmer.Server.Migrations
{
    ...
    [Migration("20230226094507_updateToNewProducts")]
    partial class updateToNewProducts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VeggieFarmer.Shared.ProductType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VeggieFarmer.Shared.ProductVariant", b =>
                {
            ...
            modelBuilder.Entity("VeggieFarmer.Shared.ProductVariant", b =>
                {
                    b.HasOne("VeggieFarmer.Shared.Product", "Product")
                        .WithMany("Variants")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("VeggieFarmer.Shared.ProductType", "ProductType")
                        .WithMany()
